            ...
            <div class="card customCard my-4">
                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                      <h5 class="text-white text-capitalize pl-3 mb-0">Page Category</h5>
                      <a href="{{URL('admin/pagecategory/add')}}" class="btn btn-default mb-0 mr-3 btn-sm text-white">Add Category</a>
                    </div>
                </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{URL('admin/pagecategory/edit/'.$p->id)}}"
                                            class="btn btn-sm btn-primary">Edit</a>&nbsp;&nbsp;<a href="javascript::void();"
                                            class="btn btn-sm btn-primary" data-toggle="modal"
                                            data-target="#deletepagecategorymodal{{$p->id}}">Delete</a>

                                        <div class="modal" id="deletepagecategorymodal{{$p->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body text-center">
                                                        <h1>Are you sure want to delete?</h1>
                                                        <a href="{{URL('admin/pagecategory/delete/'.$p->id)}}"
                ...
                <div class="card-footer py-4">
                    <nav aria-label="...">
                        <div class="justify-content-center mb-0">
                            {{$page->appends(request()->input())->links('pagination.admin')}}
                        </div>
