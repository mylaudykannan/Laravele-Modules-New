            ...
            <div class="card customCard my-4">
                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                      <h5 class="text-white text-capitalize pl-3 mb-0">Draft News</h5>
                ...
                <div class="card-body pt-2">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            <form action="{{ URL('admin/draftnews')}}" method="get">
                                <div class="row">
                                    <div class="col">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a href="{{URL('admin/draftnews/edit/'.$p->pointslug)}}"
                                                class="dropdown-item">Edit English</a>
                                            <a href="{{URL('admin/draftnews/edit/'.$p->pointslug)}}?lang=ar"
                                                class="dropdown-item">Edit Arabic</a>
                                            <a href="{{URL('admin/draftnews/edit/'.$p->pointslug)}}?lang=ru"
                                        ...
                                        <div class="modal-dialog modal-md" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <a href="{{URL('admin/draftnews/delete/'.$p->id)}}" class="btn btn-primary">Yes</a>&nbsp;&nbsp;<button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
