...
<div class="container-fluid">
    ...
    <div class="row contentTopMrg">
        ...
        <div class="col-12">
            <form action="{{ URL('admin/draftnews/store') }}" method="post" id="newsform">
                @csrf
                <div class="card customCard my-4">
                    <!-- Card header -->
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                          <h5 class="text-white text-capitalize pl-3 mb-0">Add Draft News</h5>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="form-group hidden">
                            ...
                            <textarea class="form-control" id="content" name="content"
                                placeholder="Enter Content" data-empty="Enter Content" data-allowed="news"></textarea>
                        </div>
                        <div class="form-group hidden">
                ...
                <button type="submit" class="btn btn-success pull-right"
                    onclick="if(validation(event,'#newsform')==true) $('#newsform').submit();">Save Draft</button> <a
